...
const SignUp = async () => {
  ...
  return (
    <div className='flex items-center relative justify-center h-screen'>
      <div className='bg-[url(https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg?t=st=1712118405~exp=1712122005~hmac=77bf6ea75e2ca39aa80fb9b054eb4c64428e835f09202d11dfda4499f363958a&w=900)]  absolute  top-0 left-0 bg-no-repeat bg-top w-full h-screen  bg-blend-overlay   bg-black/3x0   bg-cover'>
